...
declare class WebsocketServer extends BaseServer {
    ...
    implementation: WebSocket.Server<typeof WebSocket, typeof import("http").IncomingMessage>;
}
...
type WebSocketServerConfiguration = import("../Server").WebSocketServerConfiguration;
